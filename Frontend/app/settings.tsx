...
const QuizSettingsScreen = () => {
  ...
  const checklistItems = [
    ...
    },
    {
      ...
      onFix: () => {
        ...
        const firstIncompleteIndex = questions.findIndex(q => !isQuestionComplete(q));
  ...
  const handleSaveQuiz = async () => {
    ...
    //   alert("Por favor, añade al menos una pregunta a tu trivia.");
    //   return;
    // }
    // setIsChecklistVisible(false);
    setIsSaving(true);
    ...
    try {
      ...
      // Alert.alert(
      //   "Trivia Guardada!",
      //   "Tu nueva trivia esta lista en tu libreria",
              ...
              return (
                ...
                >
                  <View style={{flexDirection: 'row', alignItems: 'center', flex: 1}}>
                    ...
                    <Text style={styles.questionPreviewText} numberOfLines={1}>{question.text || 'Pregunta vacía'}</Text>
                  </View>
                  {!isComplete && (
...
const styles = StyleSheet.create({
  ...
  titleInput: { backgroundColor: "#1A202C", marginBottom: 0 },
  questionPreview: {
    flexDirection: "row",
    alignItems: "center",
